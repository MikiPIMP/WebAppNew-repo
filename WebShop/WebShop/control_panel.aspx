...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <div class="card">
         <div class="card-body">
              <h4 class="card-title">Dodaj Vrsta Artikala :</h4>
                  <p class="card-description">
                   Osnovne karakteristike artikla
                  </p>
       <div class="form-group">
                      <label for="exampleInputName1">Vrsta artikla:</label>
                     
                      <asp:TextBox ID="txtvrsta" runat="server" class="form-control"  placeholder="Vrsta artikla" Height="50px"></asp:TextBox> 
                    </div>
            <asp:Button ID="Button2" runat="server"  OnClick="Button2_Click" class="btn btn-primary me-2" text="Unos Artikla" />
             </div>
     </div>
